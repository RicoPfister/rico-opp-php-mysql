...
$_diagramProportionMistakes = 280/($_maxMistakes+$_maxPoints)*$_maxMistakes;
$_diagramProportionPoints = 280/($_maxMistakes+$_maxPoints)*$_maxPoints;

// Berechnung der Diagrammaufteilung für erreichtes Ergebnis

$_diagramPositionMistakes = $_diagramProportionMistakes/$_maxMistakes*$mistakes+30;

if ($_maxPoints != 0){
$_PositionPoints = $_diagramProportionPoints/$_maxPoints*$points+30;
} else {
    $_PositionPoints = 30;
}
...
<svg width='350' height='35'>
    ...
    /*for($i=1; $i<=30; $i++){
        $x = 20+$i*10;
        echo "<line x1=$x y1='6' x2=$x y2='14' style='stroke:rgb(0,0,0);stroke-width:1'/>";
    }*/
